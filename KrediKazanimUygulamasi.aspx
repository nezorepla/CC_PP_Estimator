...
<body>
    ...
    <div>
        ...
        <span id="ImportArea" runat="server" visible="false">
            <div>
                ...
                <asp:CheckBox ID="CheckBox1" runat="server" Text="Is First Row Header" Checked="true" />
                <br />
    ...
    <span id="ActionArea" runat="server">
      <div style="padding:5px;"><asp:Label ID="lblAct" runat="server"></asp:Label></div>  
        <table>
            <tr>
                <td class="style2">
                    Portföy Sorumlusu
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:Label ID="lblTakipId" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style2">
            ...
            <tr>
                ...
                <tr><td colspan=2>
                    <asp:Button ID="btnTamamla" runat="server" Text="Aksiyonları Kaydet" 
                        Width="626px" OnClick="btnTamamla_Click" /></td></tr>
            </tr>
        </table>
    </span></div>
    </form>
